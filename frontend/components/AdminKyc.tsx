...
/**
 * KYC review queue for officers/admins. Approve or reject pending submissions;
 * the automated checks are shown to assist the decision.
 */
      ...
      <div className="page-heading">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-base leading-7 text-slate-700">
            Review pending identity verifications. Automated checks are shown to assist.
          </p>
        </div>
        <AdminNav />
      </div>
